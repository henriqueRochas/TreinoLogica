using static TreinoLogico83.Program.TaskManager;

namespace TreinoLogico83
{
            ...
            do
            {
                ...
                switch (_option)
                {
                    ...
                    case 3:
                        ...
                        var checkTask = taskService.ChangeStatus(listTasks,id);
                    ...
                    case 4:
                        ...
                        var checkTask2 = taskService.ChangeStatus(listTasks, ids);
