using static TreinoLogico80.Program.TaskManager;

namespace TreinoLogico80
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("7 - Filtrar Tasks");
                ...
                switch (_opcao)
                {
                    ...
                    case 7:
                        ...
                        {
                            Console.WriteLine($"Status: {item.Key} Quantidade: {item.Count()}");
                        }
